...
.mdc-button {
  ...
  .mdc-button:not(:disabled) {
    /* @alternate */
    color: #eeeeee;
    color: var(--mdc-theme-primary, #eeeeee); }
  .mdc-button:not(:disabled) {
    ...
    .mdc-button:not(:disabled)::before {
      ...
      @supports (background-color: color(green a(10%))) {
        .mdc-button:not(:disabled)::before {
          background-color: color(var(--mdc-theme-primary, #eeeeee) a(16%)); } }
...
.mdc-button--unelevated:not(:disabled) {
  ...
  @supports not (-ms-ime-align: auto) {
    .mdc-button--raised:not(:disabled),
    .mdc-button--unelevated:not(:disabled) {
      background-color: var(--mdc-theme-primary, #eeeeee); } }
...
.mdc-button--stroked {
  ...
  .mdc-button--stroked:not(:disabled) {
    /* @alternate */
    border-color: #eeeeee;
    border-color: var(--mdc-theme-primary, #eeeeee); }
...
.mdc-checkbox {
  ...
  .mdc-checkbox .mdc-checkbox__background::before {
    ...
    @supports not (-ms-ime-align: auto) {
      .mdc-checkbox .mdc-checkbox__background::before {
        background-color: var(--mdc-theme-secondary, #eeeeee); } }
  .mdc-checkbox::before {
    /* @alternate */
    ...
    @supports (background-color: color(green a(10%))) {
      .mdc-checkbox::before {
        background-color: color(var(--mdc-theme-secondary, #eeeeee) a(14%)); } }
...
.mdc-icon-toggle--primary {
  ...
  .mdc-icon-toggle--primary::before {
    ...
    @supports (background-color: color(green a(10%))) {
      .mdc-icon-toggle--primary::before {
        background-color: color(var(--mdc-theme-primary, #eeeeee) a(14%)); } }
...
.mdc-radio {
  ...
  .mdc-radio__inner-circle {
    ...
    background-color: var(--mdc-theme-text-secondary-on-light, rgba(255, 255, 255, 0.8));
    position: absolute;
    top: 0;
    left: 0;
    -webkit-box-sizing: border-box;
...
.mdc-ripple-surface {
  ...
  .mdc-ripple-surface--accent::before {
    ...
    @supports (background-color: color(green a(10%))) {
      .mdc-ripple-surface--accent::before {
        background-color: color(var(--mdc-theme-secondary, #eeeeee) a(16%)); } }
...
.mdc-select {
  ...
  .mdc-select:focus {
    ...
    border-bottom-color: var(--mdc-theme-primary, #eeeeee);
    outline: none;
    background-color: rgba(0, 0, 0, 0.06); }
  [dir="rtl"] .mdc-select, .mdc-select[dir="rtl"] {
...
.mdc-slider {
  ...
  .mdc-slider__thumb {
    /* @alternate */
    fill: #eeeeee;
    fill: var(--mdc-theme-primary, #eeeeee);
    /* @alternate */
    stroke: #eeeeee;
    stroke: var(--mdc-theme-primary, #eeeeee);
    position: absolute;
    top: 0;
    left: 0;
    -webkit-transform: scale(0.571);
...
.mdc-theme--primary {
  ...
  color: var(--mdc-theme-primary, #eeeeee) !important; }
...
.mdc-theme--secondary {
  /* @alternate */
  color: #eeeeee !important;
  color: var(--mdc-theme-secondary, #eeeeee) !important; }
...
.mdc-theme--primary-bg {
  ...
  background-color: var(--mdc-theme-primary, #eeeeee) !important; }
...
.mdc-theme--secondary-bg {
  /* @alternate */
  background-color: #eeeeee !important;
  background-color: var(--mdc-theme-secondary, #eeeeee) !important; }
